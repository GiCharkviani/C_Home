...
int main() {
    ...
    // using default settings (precision is 6)
    ...
    // Using precision 3 and fixed - when fixed, precision applies after the decimal point
    ...
    std::cout << std::setprecision(3) << std::uppercase << std::scientific;
