...
int main() {
    ...
    // Set field width to 10 for the first 3 outputs
    ...
    // Set field width to 10 for the first 3 outputs and justify all left
    std::cout << "\n *** Width 10 for num1, num2 and hello and left for all ***" << std::endl;
    ruler();
    ...
    std::cout << "\n *** Width 10 for num1, num2 and hello and left for all and all setfill to dash ***" << std::endl;
    ruler();
    std::cout << std::setw(10) << std::left << num1
              << std::setw(10) << std::left << num2
              << std::setw(10) << std::left << hello
    ...
    std::cout << std::setfill('-');
    std::cout << "\n *** Width 10 for num1, num2 and hello - setfill varies ***" << std::endl;
    ruler();
