...
void find_test() {
    ...
    auto loc = std::find(std::begin(vec), std::end(vec), 3); // the same as vec.begin() or vec.end()
...
void all_of_test() {
    ...
    std::vector<int> vec1 {1,3,4,5,9,1,3,13,19,5};
...
void string_transform_test() {
    ...
    std::transform(str1.begin(), str1.end(), str1.begin(), ::toupper); // :: this means global scope
