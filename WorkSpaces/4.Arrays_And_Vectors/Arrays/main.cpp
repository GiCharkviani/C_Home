...
int main() {
    ...
    cout << "\nThe first voewel is: " << vowels[0] << endl;
    cout << "The last vowels is: " << vowels[4] << endl;
    cout << "enter value to add into array: " <<endl;
...
//    int test_scores [5]; // junk data
//    int test_scores [5] {}; // 0s
//    int test_scores [5] {0}; // 0s
//    int test_scores [5] {100}; // 100, 0s
