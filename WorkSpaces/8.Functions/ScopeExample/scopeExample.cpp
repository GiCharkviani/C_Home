...
int num {300}; // Global variable - declared outside any class or function - initialized only once
...
void static_local_example() {
    static int num {5000}; // local to static_local_example static - retains it value between calls, like global does, hence everytime you call func, variable is not initialized again
