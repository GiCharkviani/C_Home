...
int main()
{
    ...
    s3.at(0) = 'P';
    cout << "s3 change first letter to 'P': " << s3 << endl; // Pank
    ...
    // s3 = "nice " + " cold" + s5 + " juice"; // Compiler error - because this is C style characters
    ...
    cout << "\nSubstring"
         << "\n------------------------------" << endl;
    s1 = "This is a test";
    // first arg - from which index, sec arg - how many items
    ...
    // getline
    //  differs from c-string getline() method
    cout << "\ngetline"
         << "\n------------------------------" << endl;
    string full_name{};

    cout << "Enter your full name: ";
    getline(cin, full_name); // takes value and stores in variable
    ...
    size_t position = s1.find(word); // finds string
    if (position != string::npos) // string::npos - if not found
