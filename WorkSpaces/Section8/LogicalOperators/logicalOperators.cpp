...
int main()
{
    ...
    // Determine is you need to wear a coat based on temepature and wind speed
    bool wear_coat{false};
    double temperature{};
    int wind_speed{};

    const int wind_speed_for_coat{25};     // wind over the value requires a coat
    ...
    // Require a coat if BOTH the wind is too high AND temperature is too low
